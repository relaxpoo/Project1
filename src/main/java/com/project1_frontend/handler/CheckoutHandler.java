package com.project1_frontend.handler;
...
import com.project1_frontend.model.CheckoutModel;
import com.project1_frontend.model.OrderDetail;
import com.project1_frontend.model.OrderItem;
...
public class CheckoutHandler {
	...
	public List<Address> getShippingAddresses(CheckoutModel checkoutModel) {
		...
		List<Address> addresses = userDAO.listShippingAddresses(checkoutModel.getUser().getId());
