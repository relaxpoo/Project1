						...
						},
						{
							...
							mRender : function(data, type, row) {
								...
								str += '<a href="'
										...
										+ '/show/'
										+ data
										+ '/product" class="btn btn-info" style="font-size:20px"><i class="fa fa-eye"></i></a>';

								
								if(userRole !== 'ADMIN') {
									if (row.quantity < 1) {
										str += '<a href="javascript:void(0)" class="btn btn-danger disabled" style="font-size:18px"><i class="fa fa-opencart"></i></a>';
									} else {
										...
										str += '<a href="'
												...
												+ '/cart/add/'
												+ data
												+ '/product" class="btn btn-danger" style="font-size:18px"><i class="fa fa-opencart"></i></a>';
									}
								}
								else {
									str += '<a href="'
										...
										+ '/manage/'
										+ data
										+ '/product" class="btn btn-warning" style="font-size:20px"><i class="fa fa-pencil"></i></a>';
								}
							...
							},
							{
								...
								mRender : function(data, type, row) {
									...
									str += '<a href="'
											...
											+ '/manage/'
											+ data
											+ '/product" class="btn btn-primary" style="font-size:20px"><i class="fa fa-pencil"></i></a> &#160;';
