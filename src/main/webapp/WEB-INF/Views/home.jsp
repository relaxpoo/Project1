				...
				<div class="container-fluid textmuted text-centered">
					...
					<div class="container-fluid textmuted text-center">
						...
						<div class="row">
							...
							<div class="col-sm-3">
							<a href="${contextRoot}/show/category/21/products">
							...
							<div class="col-sm-3">
							<a href="${contextRoot}/show/category/22/products">
								<img class="img-fluid"
							...
							<div class="col-sm-3">
								<a href="${contextRoot}/show/category/23/products">
								<img class="img-fluid"
						...
						<div class="row">
							...
							<div class="col-sm-3">
							<a href="${contextRoot}/show/category/24/products">
								<img class="img-fluid"
									src="<c:url value="/resources/images/d9.jpg"/>">
								<h4>Mango</h4>
							</div>
							<div class="col-sm-3">
							<a href="${contextRoot}/show/category/25/products">
								<img class="img-fluid"
									src="<c:url value="/resources/images/d1.jpg"/>">
								<h4>Forever21</h4>
							</div>
							<div class="col-sm-3">
							<a href="${contextRoot}/show/category/26/products">
								<img class="img-fluid"
