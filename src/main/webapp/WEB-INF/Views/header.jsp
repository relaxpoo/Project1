...
<body>
	<nav class="navbar navbar-expand-sm bg-danger navbar-dark sticky-top">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav">
				<li class="nav-item">
				<li id="home"><a class="nav-link" href="${contextRoot}/home"><i class="fa fa-home" style="font-size:28px"></i></a></li>
					...
					<a
						...
						<ul class="dropdown-menu bg-dark text-white ml-auto" aria-labelledby="dropdownMenu1">
							<security:authorize access="hasAuthority('USER')">
								<li id="cart"><a href="${contextRoot}/cart/show"> <i class="fab fa-opencart" style="margin-right:20px;fornt-size:28px"></i>${userModel.cart.cartLines}</span> - &#8377;
										${userModel.cart.grandTotal}
								</a></li>
								<li role="separator" class="divider"></li>
								<li><a href="${contextRoot}/Order-Details">Order-Details</a></li>
							</security:authorize>
